                        ...
                        <div className='flex flex-col w-full relative'>
                            ...
                            <div className='feature-text-container'>
                                <div className='flex-1 flex-center'>
                                    <p className='feature-text g_text'>Iphone 15 Pro {' '} 
                                    <span className='text-white'>The first iphone to feature an aerospace-grade titanium design,</span>
                                    using the same alloy that spacecrafts use for mission to mars</p>
                                </div>
                                <div className='flex-1 flex-center'>
                                    <p className='feature-text g_text'>Titanium has one of the best strength-weight ratio of any metal, making these our  {' '} 
